...
type ReminderTone = (typeof REMINDER_TONES)[number];
...
export default function ReminderCreatePage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (!res.ok) { setError(data.message || "Failed to create sequence"); setLoading(false); return; }
  ...
  return (
    <div>
      <div className="flex items-center gap-2 mb-6">
        ...
        <h1 className="font-display font-extrabold text-2xl">New Reminder Sequence</h1>
      </div>
